...
<div class="form-wrap">
<h3><?php _e("Add a New Catalogue", 'ultimate-product-catalogue') ?></h3>
...
<div class="form-field form-required">
	...
	<p><?php _e("The name of the catalogue. This is for your own internal use, and to insert the catalogue into a page or post.", 'ultimate-product-catalogue') ?></p>
</div>
<div class="form-field">
	...
	<p><?php _e("The description of the catalogue. What will it be used to display?", 'ultimate-product-catalogue') ?></p>
</div>
<div class="form-field">
	...
	<p><?php _e("Custom CSS styles that should be applied to this catalogue.", 'ultimate-product-catalogue') ?></p>
</div>

<p class="submit"><input type="submit" class="button-primary" value="<?php _e('Add New Catalogue', 'ultimate-product-catalogue') ?>"  /></p></form></div>
<br class="clear" />
</div>
</div>
