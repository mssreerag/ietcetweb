		...
		<div class="OptionTab ActiveTab" id="EditCatalogue">
				<div class="form-wrap CatalogueDetail">
						...
						<tr>
								...
								<p><?php _e("The name of the catalogue. This is for your own internal use, and to insert the catalogue into a page or post.", 'ultimate-product-catalogue') ?></p></td>
						</tr>
						<tr>
								...
								<p><?php _e("The description of the catalogue. What products are included in this?", 'ultimate-product-catalogue') ?></p></td>
						</tr>
						<tr>
								...
								<p><?php _e("Custom CSS styles that should be applied to this catalogue.", 'ultimate-product-catalogue') ?></p></td>
						</tr>
						</table>
						
						<p class="submit"><input type="submit" name="submit" id="submit" class="button-primary" value="<?php _e('Edit Catalogue', 'ultimate-product-catalogue') ?>"  /></p>
						</form>
	...
	<div id="posttype-page" class="posttypediv">
		...
		<p class="button-controls">
			...
			<span class="add-to-menu upcp-admin-add-button">
				<input type="submit" class="button-secondary submit-add-to-menu" value="<?php _e('Add to Catalogue', 'ultimate-product-catalogue') ?>" name="add-post-type-menu-item" id="submit-posttype-page" />
			</span>
...
<!-- Show the products and categories currently in the catalogue, give the user the
	...
	<thead>
		<tr>
			...
			<th><?php _e("Catalogue Item Name", 'ultimate-product-catalogue') ?></th>
			<th><?php _e("Type of Catalogue Item", 'ultimate-product-catalogue') ?></th>
		</tr>
	</thead>
	<tfoot>
		<tr>
