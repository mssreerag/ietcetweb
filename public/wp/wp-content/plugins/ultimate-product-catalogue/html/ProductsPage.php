...
<div class="form-wrap">
<h2><?php _e("Add New Products", 'ultimate-product-catalogue') ?></h2>
...
<div class="form-field form-required">
	...
	<p><?php _e("The name of the product your users will see.", 'ultimate-product-catalogue') ?></p>
</div>
...
<div class="form-field">
	<label for="Item_Image"><?php _e("Image", 'ultimate-product-catalogue') ?></label>
	...
	<p><?php _e("The main image that will be displayed in association with this product.", 'ultimate-product-catalogue') ?></p>
</div>
<div class="form-field">
	<label for="Item_Price"><?php _e("Price", 'ultimate-product-catalogue') ?></label>
	<input name="Item_Price" id="Item_Price" type="text" value="" size="60" />
	<p><?php _e("What does this product cost?", 'ultimate-product-catalogue') ?></p>
</div>
<div class="form-field">
	...
	<p><?php _e("What price should this product be on sale for? Only shown if the checkbox below is selected, or 'Sale Mode' is selected on the 'Options' tab.", 'ultimate-product-catalogue') ?></p>
</div>
<div class="form-field">
...
<div class="form-field-small-buttons">
	...
	<p><?php _e("The description of the product. What is it and what makes it worth getting?", 'ultimate-product-catalogue') ?></p>
</div>
<div class="form-field">
...
<div class="form-field">
	...
	<p><?php _e("What category is this product in? Categories help to organize your product catalogues and help your customers to find what they're looking for.", 'ultimate-product-catalogue') ?></p>
</div>
<div class="form-field">
	...
	<p><?php _e("What sub-category is this product in? Sub-categories help to organize your product catalogues and help your customers to find what they're looking for.", 'ultimate-product-catalogue') ?></p>
</div>
<div class="form-field">
	...
	<p><?php _e("What tags should this product have? Tags help to describe the attributes of a product.", 'ultimate-product-catalogue') ?></p>
</div>
...
<h3><?php _e("Export Products to Spreadsheet", 'ultimate-product-catalogue') ?></h3>
<?php if ($Full_Version == "Yes") { ?>
	<div class="wrap">

		<form method="post" action="admin.php?page=UPCP-options&Action=UPCP_ExportToExcel">
			<p><?php _e("Downloads all products currently in the database to Excel", 'ultimate-product-catalogue') ?></p>
			<p class="submit"><input type="submit" name="Export_Submit" class="button button-primary" value="Export to Excel"  /></p>
		</form>
		<form method="post" action="admin.php?page=UPCP-options&Action=UPCP_ExportToExcel&FileType=CSV">
			<p class="submit"><input type="submit" name="Export_Submit" class="button button-primary" value="Export to CSV"  /></p>
		</form>
	</div>
<?php } else { ?>
	<div class="Explanation-Div">
		...
		<div class="upcp-full-version-explanation">
			<?php _e("The full version of the Ultimate Product Catalogue Plugin is required to export products to Excel.", 'ultimate-product-catalogue');?><a href="http://www.etoilewebdesign.com/ultimate-product-catalogue-plugin/"><?php _e(" Please upgrade to unlock this feature!", 'ultimate-product-catalogue'); ?></a>
		</div>
	</div>
<?php } ?>
