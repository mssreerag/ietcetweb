...
function UPCP_Import_WC_Custom_Field($Attribute, $Update = "No") {
	...
	$WC_Update = "Yes";
	if ($Field_ID == "") {Add_UPCP_Custom_Field($Attribute->attribute_label, $Attribute->attribute_name, $Attribute->attribute_type, "", $Attribute_Terms, "none", "No", "No", "Checkbox", $WC_Update, $Attribute->attribute_id, $Term_ID_For_Value);}
	elseif ($Update == "Yes") {Edit_UPCP_Custom_Field($Field_ID, $Attribute->attribute_label, $Attribute->attribute_name, $Attribute->attribute_type, "", $Attribute_Terms, "none", "No", "No", "Checkbox", $WC_Update, $Attribute->attribute_id, $Term_ID_For_Value, $Replace_Values);}
}
